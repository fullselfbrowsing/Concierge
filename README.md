...
>
> **Picking this up to work on it?** Start with **[HANDOFF.md](./HANDOFF.md)** — what's locked, what's open, where to start, and the traps that cost a day each if rediscovered.
