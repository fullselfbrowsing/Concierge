...
| **Measured final runtime** | 20 runtime files / 428 passed / 428 total / 0 pending / 0 todo (`pnpm test`, exit 0) |
...
| 08-04-02 | 08-04 | Completed-delivery plus confirmed human attestation conjunction, with contradictory claims terminal across shared gates | E01-E14 and M-08-E03..E06/E15 | ✅ green |
...
| 08-07-01 | 08-07 plus post-review closure | The planned 47-mutant register plus one D-08-12 contradiction-downgrade control, all revision-bound | M-08-G01..P04 plus M-08-E15, 48/48 green | ✅ green |
...
|-------------|---------|----------|--------|--------------|
| CON-01 | 08-03 | K01, public no-review flow | M-08-G01 | 428/428 runtime tests |
...
| CON-04 | 08-03 | K17-K20 | M-08-G07..G10 | 428/428 runtime tests |
| CON-05 | 08-03 | K09, K12, K17, K22-K26 | M-08-G03, M-08-G07, M-08-G12..G14 | 48/48 mutants green |
| CON-06 | 08-03 and 08-06 | K04 and interrupted-delivery flagship | M-08-G02 | Stub absent from tarball |
| CON-07 | 08-01, 08-02, 08-04, 08-05 | C27-C29, N01-N04, E12, E14 | M-08-G15, M-08-C01/C04..C07, M-08-E15 | Exact 75 names, 60 types, 15 values |
...
|----------|---------|----------|--------|--------------|
| D-08-01 | 08-03 factory-local review ledger | K03 | M-08-G01 | 48/48 mutants green |
| D-08-02 | 08-03 exact-Promise dedupe boundary | K04 | M-08-G02 | 428/428 tests |
| D-08-03 | 08-03 fresh-review replacement | E10, K07 | M-08-G03, M-08-G04 | 48/48 mutants green |
| D-08-04 | 08-03 completed owned delivery only | E09 | M-08-G05 | Public flagship passed |
| D-08-05 | 08-03 fresh human boundary | K14 | M-08-G06 | 428/428 tests |
| D-08-06 | 08-03 late detached snapshot | K26, K17 | M-08-G07, M-08-G08 | 48/48 mutants green |
| D-08-07 | 08-03 consume-before-handler | K18, K20 | M-08-G09, M-08-G10 | 48/48 mutants green |
| D-08-08 | 08-03 honest terminal outcomes | K21, K22, K24 | M-08-G11..G14 | Artifact import passed |
| D-08-09 | 08-02 and 08-03 inherent delivered floor | N01, N02, C27, C29 | M-08-G15, M-08-C01/C04/C07 | 48/48 mutants green |
...
| D-08-12 | 08-04 achieved grade from internally consistent evidence; contradictory attempted attestation is terminal rather than downgraded | J11, E12, E14 | M-08-E01, M-08-E02, M-08-E15 | 48/48 mutants green |
...
| D-08-15 | 08-04 separate presentation and observation | J06-J09 | M-08-E07..E11 | 48/48 mutants green |
| D-08-16 | 08-04 attested requires both halves | J04 | M-08-E12 | 428/428 tests |
...
| D-08-19 | 08-05 no model-authored failure prose | S06, S07 | M-08-O02, M-08-O06 | 48/48 mutants green |
| D-08-20 | 08-05 presentation fails closed | S07, J04 | M-08-O03, M-08-O04 | 428/428 tests |
...
|--------|-------------------|---------|----------|--------|--------------|
| T-08-01 | The agent self-approves in the review response or a forgeable turn | 08-02, 08-03, and 08-05 require nonempty distinct boundaries and human-attested provenance | K14, C29 | M-08-G06, M-08-C02, M-08-C03 | Build, typecheck, and 428/428 tests passed |
...
| T-08-03 | Reviewed payload or app state drifts before confirm | 08-03 compares late detached state and preserves exact payload | K17, K18, K20, K21, K26 | M-08-G07..G11 | 48/48 mutants green |
| T-08-04 | Capability declaration is mistaken for achieved proof | 08-02 through 08-05 retain the inherent delivered floor and runtime none guard and derive achieved grade only from consistent occurrence evidence | N01, N02, C27, C29, S02, E12, E14 | M-08-G15, M-08-C01/C04..C07, M-08-E15 | Exact artifact and foreign consumer passed |
| T-08-05 | Receipt/hash is forged or canonicalization collides | 08-04 owns JCS and UTF-8 bytes, recomputes digest, cross-checks receipt data, and rejects contradictory delivery claims | J02-J11, E02, E14 | M-08-E01..E09, M-08-E12..E15 | Zero dependencies and Node floor passed |
| T-08-06 | A delivery hash is mistaken for a human act | 08-04 requires a separate confirmed trustworthy attestation and closes any incomplete or contradictory attempted tuple | E02, E14, and refusal/dismissal matrix | M-08-E03..E06, M-08-E15 | 428/428 tests passed |
| T-08-07 | Retry or reentrancy arms/consumes more than once | 08-03 keeps transitions behind dedupe and consumes before app code | E09, E10, K07, K22, K24 | M-08-G03..G05, M-08-G07, M-08-G12..G14 | 48/48 mutants green |
...
| T-08-10 | Hostile callbacks/objects leak secrets or escape | 08-02 through 08-06 snapshot descriptors, contain callbacks, and emit fixed prose | K18, J08, S02, S07 | M-08-G09, M-08-E10/E11, M-08-C06, M-08-O03/O06 | 428/428 tests passed |

## Research Constraint Coverage

| Constraint | Summary | Detector | Mutant | Release fact |
|------------|---------|----------|--------|--------------|
| lazy-factory-ledger | 08-03 allocates authority per Concierge and review name | K03 and K11 | M-08-G01 | 48/48 mutants green |
| strict-jcs-utf8 | 08-04 implements RFC 8785 and hand UTF-8 under ES2022 | J01-J10 | M-08-E07..E14 | Node 22.12 import passed |
| retained-canonical-bytes | 08-04 hashes and rechecks exact retained bytes | J11 and E02 | M-08-E01..E04 | 48/48 mutants green |
...
| RESEARCH | Ledger, strict JCS and UTF-8, evidence dominance, outcome barrier, exact fixture, package boundary | Research Constraint Coverage and 48 compiled mutants | 0 |
...
| Property | Evidence |
|----------|----------|
| Immutable register | Digest `7d38c388e0918f2f2e4c1f06bebc7768c084ea116df24cacff7b7a3cafe9f244` |
| Distribution | 15 generation / 15 evidence / 7 capability / 7 outcome / 4 package (`15/15/7/7/4`) |
| Outcome | 48/48 green; zero pending, zero escaped, zero failed |
...
| `pnpm test` | Exit 0; 20 runtime files, 428 passed, 428 total, 0 pending, 0 todo |
| `pnpm check:artifact` | Exit 0; callable artifact and exact public declaration surface of 75 names / 60 types / 15 values |
| Immutable snapshot | Revision `0d30400adbe22f900d0d59be40fa35430d505c1234eca07d129f4094e3c0512f` remained byte-identical across all seven release gates |
...
- [x] The mutation register contains the 47 planned rows plus post-review M-08-E15: exactly 48 compiled, killed, restored rows.
...
**Approval:** approved 2026-08-10 — register 7d38c388e0918f2f2e4c1f06bebc7768c084ea116df24cacff7b7a3cafe9f244; 48/48 green; seven release gates green
