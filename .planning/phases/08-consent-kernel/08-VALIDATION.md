...
| 08-02-01 | 02 | 1 | CON-07 | T-08-05, T-08-10 | RFC 8785 strings/numbers/order and hand UTF-8 encode exactly | unit | `pnpm --filter @fullselfbrowsing/concierge build && pnpm exec vitest run packages/concierge/test/readback-canonicalization.test.ts` | ✅ `readback-canonicalization.test.ts` | ✅ green |
| 08-02-02 | 02 | 1 | CON-07 | T-08-04, T-08-05 | Non-JSON/alias/accessor/exotic inputs reject; sink receipt is recomputed and exact retained bytes are compared | unit + security | same exact canonicalization suite | ✅ `readback-canonicalization.test.ts` | ✅ green |
